...
#1. IMPORT ----
setwd ("C:/Users/Pauli/OneDrive/Dokumenty/kraje") # domyślnym katalogiem będzie C:/Data/project
kraje_1 = read.table("kraje_makro_1(4).csv", header=TRUE, sep=",", dec=".")
kraje_2 = read.table("kraje_makro_2(3).csv", header=TRUE, sep=",", dec=".")
